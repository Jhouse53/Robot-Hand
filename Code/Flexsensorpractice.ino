...
void loop() {
    ...
    angle = map(value, 325, 175, 0, 180);//Map value 0-1023 to 0-255 (PWM)
  ...
  /*  //flexpin1
    ...
    //Serial.println(value);               //Print value
    angle1 = map(value1, 260, 120, 0, 180);//Map value 0-1023 to 0-255 (PWM)
...
*/
    ...
    //Serial.println(value);               //Print value
    angle3 = map(value3, 325, 175, 0, 180);//Map value 0-1023 to 0-255 (PWM)
    Serial.print("\t sensor3: ");
    Serial.print(angle3);
